...
- **Calculadora** — **math.js** + **KaTeX** (CDN): tema **studio** (tarjeta clara, barra oscura, acento índigo); expresión y resultado con KaTeX; pestañas **123** / **ƒ(x)**; **Pasos y método**; historial **modal**; **Rad/Deg**, **abc**, **^·n**, cursor; plantillas **d/dx**, **∫**, **lim**, **Σ**; **C** / **CE** / **ans**. Caché: `modules.css`, `calculator.js` con `?v=` en plantillas.
