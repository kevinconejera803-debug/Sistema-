"""
Audita plantillas HTML no referenciadas por la app Tu espacio.

Uso (desde la carpeta gestor_tu_espacio, con venv activado):
  python scripts/limpiar_templates_muertos.py
  python scripts/limpiar_templates_muertos.py --apply

Requisitos: app.py y carpeta templates/ junto a app.py.
"""
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Lista o borra templates HTML no usados en Tu espacio.")
